    ...
    public class BundleConfig
    {
        ...
        private static void AddDailyTimeRecordBundles(BundleCollection bundles)
        {
            bundles.AddScriptBundle("~/scriptbundles/dailyTimeRecords",
                ...
                "~/wwwroot/scripts/dailyTimeRecords/bulkUploadModal.js",
        ...
        {
            bundles.AddScriptBundle("~/scriptbundles/loanTypes",
                "~/wwwroot/scripts/loanTypes/add.js",
                "~/wwwroot/scripts/loanTypes/edit.js",
                "~/wwwroot/scripts/loanTypes/index.js");
        }
