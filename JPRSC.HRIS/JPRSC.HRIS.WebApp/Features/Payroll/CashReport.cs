        ...
        public class QueryHandler : IRequestHandler<Query, QueryResult>
        {
            ...
            public async Task<QueryResult> Handle(Query query, CancellationToken cancellationToken)
            {
                ...
                var payrollRecords = await _db.PayrollRecords
                    ...
                    .Where(pr => pr.PayrollProcessBatchId == query.PayrollProcessBatchId && (pr.Employee.ATMAccountNumber == null || pr.Employee.ATMAccountNumber == "0") && pr.Employee.SalaryStatus != SalaryStatus.OnHold && pr.Employee.SalaryStatus != SalaryStatus.ForCheck)
