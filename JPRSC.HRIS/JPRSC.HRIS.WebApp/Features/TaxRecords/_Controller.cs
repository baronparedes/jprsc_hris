...
{
    [AuthorizePermission(Permission.TaxRecordDefault)]
    public class TaxRecordsController : AppController
    {
        private readonly IMediator _mediator;

        public TaxRecordsController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        public async Task<ActionResult> Add(Add.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully added tax record {command.Name}.");
        ...
        public async Task<ActionResult> Delete(Delete.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully deleted tax record {commandResult.Name}.");
        ...
        public async Task<ActionResult> Edit(Edit.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully edited tax record {command.Name}.");
