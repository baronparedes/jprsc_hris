using JPRSC.HRIS.Features.CustomRoles;
...
{
    [AuthorizePermission(Permission.CustomRoleDefault)]
    public class CustomRolesController : AppController
    {
        ...
        public async Task<ActionResult> Add(Add.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully added role {command.Name}.");
        ...
        public async Task<ActionResult> Delete(Delete.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully deleted role {commandResult.Name}.");
        ...
        public async Task<ActionResult> Edit(Edit.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully edited role {command.Name}.");
