using JPRSC.HRIS.Features.Banks;
...
{
    [AuthorizePermission(Permission.BankDefault)]
    public class BanksController : AppController
    {
        ...
        public async Task<ActionResult> Add(Add.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully added bank {command.Code}.");
        ...
        public async Task<ActionResult> Delete(Delete.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully deleted bank {commandResult.Code}.");
        ...
        public async Task<ActionResult> Edit(Edit.Command command)
        {
            ...
            NotificationHelper.CreateSuccessNotification(this, $"Successfully edited bank {command.Code}.");
